...
class Ersatzteil(Base):
    ...
    Bezeichnung = Column('EtBezeichnung', String(100))
    Preis       = Column('EtPreis', Float)
    Anzahl    = Column('EtAnzLager', Integer)
    Hersteller  = Column('EtHersteller', String(30))
...
class Montage(Base):
    ...
    EtID         = Column('EtID', String(5), primary_key=True, autoincrement=False)
    AufNr = Column('AufNr', Integer, primary_key=True)
    Anzahl    = Column('Anzahl', Integer)
    #Auftragsnr = relationship('Auftrag', back_populates="ListeMontage")
...
class Auftrag(Base):
    ...
    #ListeMontage = relationship("Montage", 
    #                                back_populates="Auftragsnr")
